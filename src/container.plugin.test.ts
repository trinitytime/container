...
describe('Container 2.0', () => {
  ...
  describe('with a plugin bound to dependency A', () => {
    beforeEach(() => {
    ...
    describe('and if the plugin changes the name property of the dependency', () => {
      beforeEach(() => {
  ...
  describe('with a plugin bound to container', () => {
    ...
    test('should execute the plugin on any dependency requested', () => {
      container.get(A)
      expect(plugin).toHaveBeenCalledTimes(1)
      container.get(B)
